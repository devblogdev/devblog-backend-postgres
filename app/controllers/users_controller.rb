class UsersController < ApplicationController
  ...
  # Render section ---> This API uses Json Web Tokens (JWT) for user authentication; 
  # This controller action is used when users sign up for fist time to app's frontend
